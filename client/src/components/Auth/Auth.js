...
const initialState = { firstName: '', lastName: '', birthday: '', email: '', password: '', confirmPassword: '' };
...
const SignUp = () => {
  ...
  const googleError = () => console.log('Inicio de sesión con Google FALLIDO. Intente más tarde');
      ...
      <Paper className={classes.paper} elevation={6}>
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            { isSignup && (
            <>
              <Input name="firstName" label="Primer Nombre" handleChange={handleChange} autoFocus half />
              <Input name="lastName" label="Apellido" handleChange={handleChange} half />
              <Input name="birthday" label="Fecha Nacimiento" handleChange={handleChange} type="Date" />
            ...
            { isSignup && <Input name="confirmPassword" label="Repita Contraseña" handleChange={handleChange} type="password" /> }
          </Grid>
